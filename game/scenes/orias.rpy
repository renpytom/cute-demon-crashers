...
label orias_sex:
    ...
    ori "Ah, yes... I was about to go over what I have planned for you, and the use of a safeword. A safeword is basically something you utter to stop completely."
    ...
    menu:
        ...
        "Red.":
            ...
            "My head finds a comfortable spot on his stomach, and I close my eyes..."
            call credits
            jump orias_epilogue
    ...
    menu:
        "Let him continue.":
            ...
            $orilay_panties = "off"
            "My stomach coils from the closing distance, and his lips brush the tips of my pubic hair. After a deep breath, I widen my legs a little, and he begin massaging my inner thighs."
            ori "I'm glad you enjoyed the sensational play..."
            show orias_finish oral with dissolve
            "With long broad strokes, he parts my lips, licking each side tenderly. I turn my head to the side, my body highly sensitive to every movement." 
            #remove stop button
            ...
            if orilay_tiedup == True:
                "Being binded only adds a sweet layer of pleasure – unable to adjust myself or clutch onto the sheets." 
            "Orias teases my clit with unhurried licks, and I keep moaning softly depending on his angles."
            cla "...ah..."
            $orilay_clface="O"
            ...
            "I feel a hand caress my forehead, removing sweat."
        ...
        "Request fingers instead.":
            ...
            $orilay_panties = "off"
            "His finger travels through my hair, then dips into the parting, already moist. I widen my legs slightly to make it accessible."
            ...
            cla "Ng..."
            "My legs squirm as he increases his vigor, his fingers first making circular motions over my clit before settling on up and down motions." 
            if orilay_tiedup == "True":
                "Having my wrists bound adds a new sensation of pleasure. I'm unable to balance myself or clutch the sheets beside me, instead my arms harmlessly quiver along with my body."
            $orilay_clface ="O"
            ...
            "A calming slowly takes over, although I still feel occasional tingles and the soft throbbing between my thighs."
            hide orias_finish with dissolve
            $orilay_clface ="happy"
            ori "Enjoyed yourself?"
            cla "Heh, you'd hope so after that..."
            cla "Wow..."
            if orilay_blindfold and orilay_tiedup == True:
    ...
    label oriasstopearly:
        cla "I'm sorry for stopping the session so soon..."
        ori "No, don't be. You don't need to force yourself to do anything you're not comfortable with."
        cla "Thank you, Orias." 
        cla "Um, would it be too vanilla to ask for a cuddle at least?"
    ...
    label oriasstopmiddle:
        ...
        cla "Yes... Um, sorry for ending it after we had a good mood going... I felt I had enough."
        if coldplay == "True":
        ...
        ori "You did well on your first session. I even got nourished during the session."
        cla "Ah... then I'm glad it worked out..."
        cla "Um... would it be too vanilla if I asked for a cuddle now...?"
    ...
    label oriasstoplate:
        cl "..."
        ori "Are you alright?"
        cla "Yeah... I'm sorry. We were pretty far, and I suddenly felt like I had to stop."
        ori "I understand. It's not always easy having someone in control for that long."
        cla "I apologize for ruining everything..."
        ...
        cla "Yeah... Maybe I went over my head a bit... but I'm glad I got to try it with you, Orias."
        cla "Can we do something more, uh, tame? Like a cuddle?"
...
label orias_epilogue_long:
    ...
    $orias.set_state(eyes= "side", mouth="oh", eyebrows="default", emotion="default", emotion_base="default")
    ...
    $orias.set_state(eyes= "default", mouth="smile", eyebrows="default", emotion="default", emotion_base="default")
    "He holds up a small container tied with a pretty ribbon on top."
    $orias.set_state(eyes= "wink", mouth="grin", eyebrows="tender", emotion="note", emotion_base="default")
    ori "I thought that you might have missed my specialty tea, so I brought some..." 
    $orias.set_state(eyes= "happy", mouth="grin", eyebrows="tender", emotion="default", emotion_base="default")
    ...
    $orias.set_state(eyes= "wide", mouth="default", eyebrows="up", emotion="default", emotion_base="default")
    ...
    $orias.set_state(eyes= "default", mouth="default", eyebrows="default", emotion="default", emotion_base="default")
    ...
    $orias.set_state(eyes= "side", mouth="default", eyebrows="tender", emotion="default", emotion_base="default")
    ...
    $orias.set_state(eyes= "wide", mouth="oh", eyebrows="up", emotion="default", emotion_base="default")
    ori "And this is...?"
    $orias.set_state(eyes= "wide", mouth="default", eyebrows="up", emotion="default", emotion_base="default")
    ...
    $orias.set_state(eyes= "squint", mouth="neutral", eyebrows="tender", emotion="default", emotion_base="default")
    ...
    $orias.set_state(eyes= "side", mouth="oh", eyebrows="tender", emotion="default", emotion_base="small blush")
    ori "It appears you... missed something other than my tea." 
    $claire.set_state(eyes="down", emotion="default", eyebrows="default", mouth="smile", emotion_base="small blush")
    cl "Yeah."
    $orias.set_state(eyes= "default", mouth="smile", eyebrows="tender", emotion="default", emotion_base="small blush")
    ori "I promise that the feeling's mutual."
    $orias.set_state(eyes= "happy", mouth="smile", eyebrows="tender", emotion="heart", emotion_base="default")
    ...
    $orias.set_state(eyes= "default", mouth="oh", eyebrows="up", emotion="default", emotion_base="default")
    ori "And they are...?"
    $orias.set_state(eyes= "wide", mouth="low", eyebrows="up", emotion="default", emotion_base="small blush")
    ...
    $orias.set_state(eyes= "side", mouth="smile", eyebrows="tender", emotion="default", emotion_base="default")
    ...
    cl "Aaaand..."
    $orias.set_state(eyes= "wide", mouth="default", eyebrows="up", emotion="bars", emotion_base="default")
    ...
    cl "Try me."
    $orias.set_state(eyes= "closed", mouth="uhh", eyebrows="default", emotion="default", emotion_base="small blush")
    ...
    $orias.set_state(eyes= "wink", mouth="smile", eyebrows="tender", emotion="default", emotion_base="default")
    ori "Remember, there's no rush. We can take our time with these arrangements."
    $orias.set_state(eyes= "side", mouth="oh", eyebrows="tender", emotion="default", emotion_base="small blush")
    ori "Now regarding the first request..."
    $orias.set_state(eyes= "closed", mouth="smile", eyebrows="tender", emotion="default", emotion_base="small blush")
