...
label credits:
    ...
    $renpy.pause(2.0, hard=True)
    show text "{color=#000}And of course to our loving and supporting fans!\n We wouldn't have been able to get this all done without you <3{/color}" with dissolve
    $renpy.pause(2.0, hard=True)
